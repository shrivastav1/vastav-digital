...
export function CTA() {
  return (
    <section className="mx-auto w-full max-w-7xl px-6 pb-24">
      <div className="relative overflow-hidden rounded-3xl bg-[oklch(0.16_0.02_260)] p-10 md:p-16">
        <div className="absolute -right-24 -top-24 h-96 w-96 rounded-full opacity-40 blur-3xl" style={{ background: "radial-gradient(circle, #1E5BFF, transparent 60%)" }} />
        <div className="absolute -left-24 -bottom-24 h-96 w-96 rounded-full opacity-40 blur-3xl" style={{ background: "radial-gradient(circle, #6DA7FF, transparent 60%)" }} />
        <div className="relative grid gap-8 md:grid-cols-[1.4fr_1fr] md:items-end">
          ...
          <div className="flex flex-col gap-3 md:items-end">
            ...
            <Link to="/services" className="inline-flex items-center justify-center gap-2 rounded-full border border-white/20 bg-white/5 px-6 py-3 text-sm font-medium text-white hover:bg-white/10">
